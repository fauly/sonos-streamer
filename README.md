...
## The problem
My required application was being able to easily stream to a sonos S1 system with minimal control required, so my computers ip address is the url for a radio station on TuneIn via the Sonos App.

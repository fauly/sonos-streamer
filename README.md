This app takes audio input from computer default speaker and creates a streaming url that can easily be accessed by most smart speakers.
...
[![Latest Release](https://img.shields.io/github/v/release/fauly/sonos-streamer)](https://github.com/fauly/sonos-streamer/releases)
